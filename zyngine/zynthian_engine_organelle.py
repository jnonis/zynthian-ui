...
class zynthian_engine_organelle(zynthian_engine):
	...
	def cb_select_line(self, path, args):
		...
		self.zyngui.screens['control_organelle'].listdisplay.selection_clear(0, "end")
		self.zyngui.screens['control_organelle'].listdisplay.selection_set(args[0])

	def update_gui_display(self, index, args):
		line = ""
		for part in args:
			line = line + str(part) + " "
		self.zyngui.screens['control_organelle'].listdisplay.delete(index)
		self.zyngui.screens['control_organelle'].listdisplay.insert(index, line)
